      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {WHY_ZYNEX.map((item, i) => (
            <div key={i} className="group card-hover bg-gradient-to-br from-white/[0.03] to-green-950/10 border border-white/5 rounded-2xl p-8 hover:border-brand-green/30 transition-all duration-300">
