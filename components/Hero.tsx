      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 max-w-5xl mx-auto animate-in delay-400">
          {filteredStats.map((stat, i) => (
            <div
              key={i}
              className="group relative px-8 py-6 rounded-4xl bg-brand-card/30 border border-white/5 backdrop-blur-xl transition-all duration-500 hover:bg-brand-green/5 hover:border-brand-green/30 active:scale-[0.98] active:bg-brand-green/10 w-full sm:w-auto sm:min-w-[320px] cursor-pointer touch-manipulation"
            >
