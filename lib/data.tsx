...
export const COURSES = [
  {
    ...
    desc: "Master MongoDB, Express.js, React, and Node.js to become a complete full-stack developer with hands-on projects.",
    badge: "POPULAR",
    ...
    modules: 12,
    projects: 8,
    installment: "Rs. 1,999",
    rating: 4.9,
    level: "Beginner → Pro",
    topics: ["HTML", "CSS", "Tailwind CSS", "JavaScript", "React", "Next.js", "Node.js", "Express.js", "MongoDB", "REST APIs", "TypeScript"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Comprehensive AI course covering Machine Learning and Deep Learning with practical projects and real-world applications.",
    badge: "ADVANCED",
    color: "from-green-700 to-emerald-900",
    duration: "3 Months",
    students: "2790+",
    modules: 16,
    projects: 12,
    installment: "Rs. 2,499",
    rating: 4.8,
    level: "Intermediate → Expert",
    topics: ["Python", "TensorFlow", "PyTorch", "Scikit-learn", "OpenCV", "NLP", "Keras", "Pandas", "NumPy", "Matplotlib", "Seaborn", "Deep Learning", "Machine Learning"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Master cybersecurity fundamentals, ethical hacking techniques, threat detection, penetration testing, and secure system architecture.",
    badge: "ADVANCE",
    color: "from-green-700 to-emerald-900",
    duration: "3 Months",
    students: "3390+",
    ...
    rating: 4.9,
    level: "Advanced",
    topics: ["Ethical Hacking", "Network Security", "Penetration Testing", "Cyber Threat Analysis", "Information Security", "Vulnerability Assessment", "Firewall", "Cryptography", "Risk Management"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Learn Python, SQL, and data visualization tools to become a professional data analyst with industry-ready skills.",
    badge: "ADVANCE",
    color: "from-green-700 to-emerald-900",
    duration: "3 Months",
    students: "2285+",
    ...
    rating: 4.8,
    level: "Advanced",
    topics: ["Python", "R", "SQL", "Excel", "Google Sheets", "Power BI", "Tableau", "Apache Spark", "Hadoop", "Pandas", "NumPy"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Master Spoken English in just 3 months! Improve your grammar, pronunciation, vocabulary, and conversational skills. Gain confidence in every conversation.",
    badge: "ESSENTIAL",
    color: "from-green-700 to-emerald-900",
    duration: "3 Months",
    students: "850+",
    ...
    rating: 4.7,
    level: "All Levels",
    topics: ["English Communication", "Pronunciation", "Grammar for Speaking", "Daily Vocabulary", "Public Speaking", "Interview Communication", "Professional English", "Confidence Building"],
    cert: true,
  ...
  },
  {
    icon: "UX",
    title: "UI / UX Design",
    desc: "Master modern UI/UX design principles, user research, wireframing, prototyping, and usability testing to create intuitive and engaging digital experiences.",
    badge: "CREATIVE",
    color: "from-green-700 to-emerald-900",
    duration: "2 Months",
    students: "1420+",
    ...
    rating: 4.9,
    level: "Beginner → Pro",
    topics: ["UI Design", "UX Research", "Wireframing", "Prototyping", "Figma", "Adobe XD", "Design Systems", "Usability Testing", "User Journey", "Responsive Design"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Learn DevOps tools and practices including CI/CD pipelines, cloud infrastructure, automation, containerization, and monitoring for scalable applications.",
    badge: "TECHNICAL",
    color: "from-green-700 to-emerald-900",
    duration: "3 Months",
    students: "850+",
    ...
    topics: ["Linux", "Git", "CI/CD", "Docker", "Kubernetes", "AWS", "Terraform", "Monitoring", "DevSecOps"],
    cert: true,
  ...
  },
  {
    icon: "SOC",
    title: "SOC Analyst",
    desc: "A Security Operations Center (SOC) Analyst is a cybersecurity professional responsible for monitoring, detecting, and responding to cyber threats.",
    badge: "FOCUSED",
    color: "from-green-700 to-emerald-900",
    duration: "12 weeks",
    students: "1246+",
    ...
    rating: 4.9,
    level: "Intermediate",
    topics: ["security operations", "threat detection", "incident response", "SIEM", "log analysis", "network security", "endpoint security", "vulnerability assessment", "threat intelligence", "malware analysis"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Digital Marketing with AI combines data-driven strategies and intelligent automation to deliver faster, smarter, and more personalized marketing results.",
    badge: "MODERN",
    color: "from-green-700 to-emerald-900",
    duration: "2 Months",
    students: "850+",
    ...
    rating: 4.8,
    level: "Beginner → Pro",
    topics: ["social media marketing", "social media management", "email marketing", "lead generation", "Google Ads", "Meta Ads", "PPC advertising", "campaign management", "conversion rate optimization (CRO)", "A/B testing"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Graphic Designing is the art of creating visually compelling content to communicate ideas, build brand identity, and engage audiences through creative visual storytelling.",
    badge: "ARTISTIC",
    color: "from-green-700 to-emerald-900",
    duration: "2 Months",
    students: "1426+",
    ...
    rating: 4.9,
    level: "Beginner → Pro",
    topics: ["logo design", "branding", "typography", "color theory", "layout design", "Adobe Photoshop", "Adobe Illustrator", "Adobe InDesign", "social media design", "banner design", "UI design", "UX basics", "print design"],
    cert: true,
  ...
  },
  {
    ...
    desc: "Search Engine Optimization (SEO) is the process of improving a website’s visibility on search engines like Google to attract organic (non-paid) traffic and maximize digital reach.",
    badge: "RANKING",
    color: "from-green-700 to-emerald-900",
    duration: "2 Months",
    students: "0+",
    ...
    topics: ["keyword research", "on-page SEO", "off-page SEO", "technical SEO", "link building", "content optimization", "SEO audits", "competitor analysis", "Google Analytics", "Google Search Console", "backlink analysis", "site speed optimization", "mobile SEO", "local SEO", "schema markup"],
    cert: true,
